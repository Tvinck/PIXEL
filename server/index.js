...
async function setupRouting() {
    if (process.env.VERCEL || process.env.SINGLE_PROCESS === 'true' || !process.env.MICROSERVICES) {
        console.log('   📦 In-process server mode enabled. Mounting sub-apps directly in-process...');
