 ...
 */
export const TelegramCard = ({ children, onClick, className = '' }: any) => {
    return (
        <motion.div
            className={className}
 ...
 */
export const TelegramButton = ({ children, onClick, variant = 'primary', className = '' }: any) => {
 ...
 */
export const TelegramListItem = ({ children, delay = 0, onClick }: any) => {
    return (
        <motion.div
 ...
 * Telegram-style Modal/Drawer
 */
export const TelegramModal = ({ isOpen, onClose, children, fromBottom = true, className = '' }: any) => {
 ...
 */
export const TelegramFAB = ({ icon, onClick, className = '' }: any) => {
    return (
        <motion.button
 ...
 */
export const TelegramSkeleton = ({ width = '100%', height = '20px', className = '' }: any) => {
    return (
        <motion.div
 ...
 */
export const TelegramBadge = ({ count, className = '' }: any) => {
 ...
 */
export const TelegramSwipeCard = ({ children, onSwipeLeft, onSwipeRight, className = '' }: any) => {
 ...
 */
export const TelegramProgress = ({ progress = 0, className = '' }: any) => {
    return (
 ...
 */
export const TelegramShimmer = ({ children, className = '' }: any) => {
    return (
 ...
 */
export const useParallax = (value: any, distance = 50) => {
