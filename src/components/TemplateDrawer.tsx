...
const TemplateDrawer = ({ isOpen, onClose, template }: any) => {
    ...
    const handleGenerate = () => {
        // Validation
        const validFiles = selectedFiles.filter((f: any) => f).length;
    ...
    const isFilesReady = selectedFiles.filter((f: any) => f).length >= requiredFilesCount;
