...
const RepeatFlowIcon = ({ size = 20, className = '' }: any) => (
...
const GlobeAnimIcon = ({ size = 20, isActive = false, className = '' }: any) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
const ShareIcon = ({ size = 20, className = '' }: any) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        <motion.circle cx="18" cy="5" r="3" stroke="currentColor" strokeWidth="1.5"
            initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring' as const, delay: 0.2 }}
        />
        <motion.circle cx="6" cy="12" r="3" stroke="currentColor" strokeWidth="1.5"
            initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring' as const, delay: 0.1 }}
        />
        <motion.circle cx="18" cy="19" r="3" stroke="currentColor" strokeWidth="1.5"
            initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring' as const, delay: 0.3 }}
        />
...
const DownloadAnimIcon = ({ size = 20, className = '' }: any) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
const TrashAnimIcon = ({ size = 20, className = '' }: any) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
const UpscaleIcon = ({ size = 18, className = '' }: any) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
const ActionButton: React.FC<ActionButtonProps> = ({ onClick, icon, label, className = '', spanClass = 'col-span-2', delay = 0, children = null }) => (
    <motion.button
        onClick={onClick}
