...
const AvatarTrainer = ({ isOpen, onClose }: any) => {
    ...
    const handleUpload = (e: any) => {
        ...
        finalFiles.forEach((file: any) => {
            ...
            reader.onload = (ev: any) => {
                setImages((prev: any) => [...prev, ev.target.result]);
            };
    ...
    const startTraining = async () => {
        ...
        try {
            ...
            // Use Secure API
            const result = await (aiService as any).trainModel(images, triggerWord, modelType);
