...
const AnimatedIcon = ({
    ...
    const variants = {
        ...
        hover: disableHover ? {} : {
            ...
            transition: {
                rotate: { repeat: Infinity, duration: 2.5, ease: "easeInOut" as const },
                scale: { type: 'spring' as const, stiffness: 500, damping: 15 }
            }
        },
        tap: disableTap ? {} : {
            scale: 0.82,
            transition: { type: 'spring' as const, stiffness: 600, damping: 15 } // Very snappy tap
        }
    };
