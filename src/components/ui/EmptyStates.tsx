        ...
        >
            ...
            >
                ...
                {illustration ? (
                    ...
                    >
                        <AnimatedIcon icon={Icon} size={40} color="" className="text-slate-400 dark:text-slate-500" delay={0.2} />
                    </motion.div>
                )}
            </motion.div>
...
export const EmptyHistory: React.FC<any> = ({ onCreateClick }: any) => (
    <EmptyState
        icon={History}
...
export const EmptyGallery: React.FC<any> = ({ onExploreClick }: any) => (
    <EmptyState
        icon={ImageOff}
        title="Галерея пуста"
...
export const EmptyNotifications: React.FC<any> = () => (
    <EmptyState
        icon={Bell}
...
export const EmptySearch: React.FC<any> = ({ query }: any) => (
    <EmptyState
        icon={Search}
...
export const EmptyInbox: React.FC<any> = () => (
    <EmptyState
        icon={Inbox}
        title="Все прочитано"
...
export const EmptyFavorites: React.FC<any> = ({ onBrowseClick }: any) => (
    <EmptyState
        icon={Heart}
...
export const EmptyAchievements: React.FC<any> = () => (
    <EmptyState
        icon={Trophy}
...
export const EmptyCreations: React.FC<any> = ({ onStartClick }: any) => (
    <EmptyState
        icon={Sparkles}
