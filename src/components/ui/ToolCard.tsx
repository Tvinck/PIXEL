...
const ToolCard: React.FC<ToolCardProps> = React.memo(({ icon, title, subtitle, color, bg = "bg-white dark:bg-slate-800", delay, onClick }: ToolCardProps) => {
    ...
    return (
        ...
        >
            ...
            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center bg-gradient-to-br ${gradientClass} shadow-lg text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 relative z-10`}>
                ...
                {icon && React.cloneElement(icon as any, { size: 26, strokeWidth: 2, className: "drop-shadow-md" })}
            </div>
