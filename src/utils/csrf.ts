...
class CSRFProtection {
     ...
     */
    protectedFetch(url: string, options: any = {}) {
 ...
 */
export const withCSRFProtection = (WrappedComponent: any) => {
    return function CSRFProtectedComponent(props: any) {
