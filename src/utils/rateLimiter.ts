...
class RateLimiter {
     ...
     */
    check(key: any, type: string = 'default'): any {
     ...
     */
    reset(key: any, type: string = 'default') {
        const userKey = `${key}:${type}`;
 ...
 */
export const useRateLimit = (userId: any, type: string = 'default') => {
    const checkLimit = () => {
 ...
 */
export const rateLimitMiddleware = (userId: any, type: string = 'default') => {
